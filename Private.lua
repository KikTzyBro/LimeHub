...
local BlockFishNotifToggle = Discord:Toggle({
    Title = "Block Fish Notification",
    Default = false,
    Callback = function(value)
        _G.BlockFishNotif = value
        if value then
            spawn(function()
                local smallNotification = game:GetService("Players").LocalPlayer.PlayerGui:WaitForChild("Small Notification")
                while _G.BlockFishNotif do
                    for _, child in pairs(smallNotification:GetChildren()) do
...
local locationCFrames = {
    ...
    ["Jungle"] = CFrame.new(1491.21667, 6.35540199, -848.057617, -0.983971834, -4.97116588e-08, 0.178324088, -6.5941947e-08, 1, -8.50886792e-08, -0.178324088, -9.54838981e-08, -0.983971834)
}
...
Shop:Dropdown({
    Title = "Select Bait",
    Values = { "Topwater Bait", "Luck Bait", "Midnight Bait", "Nature Bait", "Chroma Bait", "Dark Matter Bait", "Corrupt Bait", "Aether Bait", "Floral Bait" },
    Value = "Topwater Bait",
    Callback = function(option)
